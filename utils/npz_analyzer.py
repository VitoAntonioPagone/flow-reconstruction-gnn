...
def print_npz_info(npz_data):
    ...
    if set(['x_velocity', 'y_velocity', 'z_velocity']).issubset(npz_data.keys()):
...
npz_file_path = "../dataset_graph/original_data/npz_data/train_inputs/cyc11_CAD605_Y0_Z0_X0.npz"
