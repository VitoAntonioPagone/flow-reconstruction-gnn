...
# ---------------------------------------------------------
databasesPath = "/p/scratch/dems/bdanciu/nekRS/TUD/1500rpm/cyc10/grid1_600CAD/tud.nek5000"

timeStartDatabase = 14

# Output directory
outputPath = "/p/scratch/dems/bdanciu/ML/2D_slices/test"
...
for i in range(y_len):
    ...
    for j in range(z_len):
        for k in range(x_len):
            ...
            e.db_type = "VTK"
            e.variables = ("x_velocity", "y_velocity", "z_velocity", "temperature")
