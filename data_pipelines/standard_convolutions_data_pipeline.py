...
TRAIN_INPUT_FOLDER = "../dataset_convnet/original_data/train"
TRAIN_OUTPUT_FOLDER = "../dataset_convnet/original_data/npz_data/train"
TEST_INPUT_FOLDER = "../dataset_convnet/original_data/test"
TEST_OUTPUT_FOLDER = "../dataset_convnet/original_data/npz_data/test"
INTERPOLATED_TRAIN_OUTPUT_FOLDER = '../dataset_convnet/npz_data_interpolated/train/'
INTERPOLATED_TEST_OUTPUT_FOLDER = '../dataset_convnet/npz_data_interpolated/test/'
OUTPUT_TRAIN_INPUTS_DIR = f'../dataset_convnet/train_data_{PERCENT_TO_REMOVE}/train_inputs_{PERCENT_TO_REMOVE}/'
OUTPUT_TEST_INPUTS_DIR = f'../dataset_convnet/train_data_{PERCENT_TO_REMOVE}/test_inputs_{PERCENT_TO_REMOVE}/'
OUTPUT_TRAIN_LABELS_DIR = f'../dataset_convnet/train_data_{PERCENT_TO_REMOVE}/train_labels_{PERCENT_TO_REMOVE}/'
OUTPUT_TEST_LABELS_DIR = f'../dataset_convnet/train_data_{PERCENT_TO_REMOVE}/test_labels_{PERCENT_TO_REMOVE}/'
OUTPUT_VAL_INPUTS_DIR = f'../dataset_convnet/train_data_{PERCENT_TO_REMOVE}/val_inputs_{PERCENT_TO_REMOVE}/'
OUTPUT_VAL_LABELS_DIR = f'../dataset_convnet/train_data_{PERCENT_TO_REMOVE}/val_labels_{PERCENT_TO_REMOVE}/'
...
def interpolate_data(input_folder, output_folder):
    """Interpolate NPZ data to regular grid."""
...
def create_inputs_labels(input_dir, output_dir_input, output_dir_labels, percent_to_remove):
    """Create input and label arrays from NPZ files."""
