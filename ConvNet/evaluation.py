...
def run_autoencoder(input_file, label_file):
    ...
    def predict():
        ...
        # Calculate the RMSE and MAE for x-velocity and y-velocity
        rmses = []
        maes = []
        ...
        # Calculate velocity magnitudes for predictions and ground truth
        ...
        # Calculate and append RMSE and MAE for velocity magnitude at the end
        ...
        rmses.append(rmse_velocity_magnitude)  # Append after x-velocity and y-velocity values
        maes.append(mae_velocity_magnitude)   # Append after x-velocity and y-velocity values
