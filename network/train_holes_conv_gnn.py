...
from models import GraphSAGE_90, GraphSAGE_95, GAT_90, GAT_95, ChebNet_90, AGNN_90, GIN_90, GraphSAGE_99, Hole_GraphSAGE_99
...
MODEL_NAME = f"GraphSAGE_box_{BOX_PERCENTAGE * 100}" 
