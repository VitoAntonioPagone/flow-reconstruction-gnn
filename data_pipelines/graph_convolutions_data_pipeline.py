...
TRAIN_INPUT_FOLDER = "../gacn_dataset_graph/original_data/train"
TRAIN_OUTPUT_FOLDER = "../gacn_dataset_graph/original_data/npz_data/train"
TEST_INPUT_FOLDER = "../gacn_dataset_graph/original_data/test"
TEST_OUTPUT_FOLDER = "../gacn_dataset_graph/original_data/npz_data/test"
VALIDATION_DIR_INPUT = "../gacn_dataset_graph/original_data/npz_data/validation"
RANDOM_SEED = 1
VALIDATION_SPLIT = 0.1
MISSING_PERCENTAGE = 98
NUM_NEIGHBOURS = 8
SAVE_GRAPHS_FOLDER = "../gacn_dataset_graph/training_FP"
...
def add_gaussian_noise_to_features(features, mean, std_dev):
    """Add Gaussian noise to the first three features."""
...
def extract_random_points(data, percentage):
    """Extract random points from data based on percentage."""
...
if __name__ == "__main__":
    ...
    create_graphs(
        TRAIN_OUTPUT_FOLDER,
        NUM_NEIGHBOURS,
        os.path.join(SAVE_GRAPHS_FOLDER, f"train_graphs_{MISSING_PERCENTAGE}"),
        is_input=False,
    )
    ...
    create_graphs(
        TRAIN_OUTPUT_FOLDER + f"_inputs_{MISSING_PERCENTAGE}",
        NUM_NEIGHBOURS,
        os.path.join(SAVE_GRAPHS_FOLDER, f"train_input_graphs_{MISSING_PERCENTAGE}"),
        is_input=True,
    )
    ...
    create_graphs(
        VALIDATION_DIR_INPUT + f"_inputs_{MISSING_PERCENTAGE}",
        NUM_NEIGHBOURS,
        os.path.join(
            SAVE_GRAPHS_FOLDER, f"validation_input_graphs_{MISSING_PERCENTAGE}"
        ),
        is_input=True,
    )
    ...
    create_graphs(
        ...
        NUM_NEIGHBOURS,
        os.path.join(SAVE_GRAPHS_FOLDER, f"validation_graphs_{MISSING_PERCENTAGE}"),
        is_input=False,
    )
