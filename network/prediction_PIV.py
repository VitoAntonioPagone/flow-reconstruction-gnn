...
CHECKPOINT_PATH = '../trained_models_FP_full/FLUID_skip_GAT_8_98_epochs_20_lr_0.0001_batch_1.pth.tar' 
...
def run_GCN(input_file, label_file):
    ...
    # Define grid size
    grid_size = 40  # Increased for a smoother plot
    ...
    fig, axs = plt.subplots(4, 2, figsize=(10, 10))  # Changed the subplot configuration
    ...
    for i in range(2):
        ...
        #grid_output_values = gaussian_filter(grid_output_values, sigma=0.1)
